...
def _build_system_prompt() -> str:
    return (
        ...
        "- CRITICAL: If has_selected_products=True and message asks about product details (materials, colors, "
        "sizes, price, availability, description, features), KEEP domain=sales. User is asking about "
        "the products being discussed, not a general store question.\n"
